...
const SharingTab: React.FC<Props & DispatchProps & StateProps> = ({
  ...
  useEffect(() => {
    setPublicLinkMode(form?.publicLink?.active ?? false);
  }, []);
    ...
    <div className="cf-advanced-row">
      <div className="cf-field">
        <CustomSwitch
          ...
          onChange={e => { handleShareMode({ mode: e.target.checked ? SHARE_MODE.SYSTEM_USERS : '' }); }}
          label={intl.messages['forms.new.systemUsers']}
          disabled={shareMode === SHARE_MODE.PUBLIC_LINK}
      ...
      <div className="cf-field">
        <CustomSwitch
          ...
          disabled={shareMode === SHARE_MODE.SYSTEM_USERS}
